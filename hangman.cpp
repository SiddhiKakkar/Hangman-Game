...
void create_usedseries(char temp_table[row/10][column],int x,int length){
	node *temp=NULL;
	for(int i=0;i<x;i++){
...
int hangman(char table1[row][column],int table2[MAX_length][7]){
	...
	int length=0,flag=0,fail_counter=0,pass_flag=0,firstime=0;
	int prelife=5,repeat=0,won=1,victory=0,num=1;
...
int main(){
	...
	cout<<"victory:"<<victory<<" "<<"loss:"<<50000-victory<<endl;
    int per = (victory*100)/50000;
    cout<<per<<endl;
	cout<<"\n\n---------END---------\n\n";
	return 0;
}
